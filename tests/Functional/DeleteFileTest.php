...
#[CoversNothing]
class DeleteFileTest extends AbstractFunctionalTestCase
{
    ...
    public function testInvoke(): void
    {
        ...
        $this->client->request('DELETE', '/log-viewer/api/file/' . self::getShortMd5('resources/Functional/log/test.log'));
