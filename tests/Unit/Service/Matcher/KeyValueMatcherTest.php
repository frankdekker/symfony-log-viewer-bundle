...
class KeyValueMatcherTest extends TestCase
{
    ...
    {
        $record = new LogRecord('id', 'record', 2000000, 'Warning', 'app', 'message', [], ['key' => 'value']);
    ...
    {
        $record = new LogRecord('id', 'record', 2000000, 'Warning', 'app', 'message', [], 'value');
    ...
    {
        $record = new LogRecord('id', 'record', 2000000, 'Warning', 'app', 'message', [], ['key1' => ['key2' => 'value']]);
    ...
    {
        $record = new LogRecord('id', 'record', 2000000, 'Warning', 'app', 'message', [], ['key' => new stdClass()]);
        $term   = new KeyValueTerm(KeyValueTerm::TYPE_EXTRA, ['key'], 'value');
