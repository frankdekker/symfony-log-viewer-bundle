...
{
    private FinderService&MockObject $folderService;
    ...
    {
        parent::setUp();
        $this->folderService    = $this->createMock(FinderService::class);
    ...
    public function testGetFilesAndFolders(): void
    {
        ...
        $this->folderService->expects(self::once())->method('findFiles')->willReturn($finder);
